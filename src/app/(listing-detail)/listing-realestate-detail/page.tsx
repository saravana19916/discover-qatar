...
export interface ListingRealestateDetailPageProps {}

const ListingRealestateDetailPage: FC<ListingRealestateDetailPageProps> = ({}) => {
  //
  ...
  const renderSection2 = () => {
    return (
      <div className="listingSection__wrap">
        <h2 className="text-2xl font-semibold">Accommodation Information</h2>
        <div className="w-14 border-b border-neutral-200 dark:border-neutral-700"></div>
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
            Two bedroom flat in the middle of the Pearl area in Qatar near to a lot of beautiful restaurants entertainment area International boutiques shops and marine area.
          </span>
          <br />
{/*          <br />
          <span>
  ...
  return (
    <div className="nc-ListingRealestateDetailPage">
      {/*  HEADER */}
...
export default ListingRealestateDetailPage;
